...
const DICT = {
  ja: {
    ...
    "proll.hint": "クリック=追加 / ドラッグ=移動 / 右端ドラッグ=長さ / ⌥クリックor右クリック=削除 / ホイール=スクロール / ⌘ホイール=ズーム / ノート上ホイール=ベロシティ",
  ...
  en: {
    ...
    "fx.hpf": "LO-CUT", "fx.low": "LOW", "fx.mid": "MID", "fx.high": "HIGH", "fx.comp": "COMP", "fx.hall": "HALL", "fx.room": "ROOM",
    "proll.title": "PIANO ROLL",
    "proll.hint": "Click=add / Drag=move / Drag right edge=length / ⌥click or right-click=delete / Wheel=scroll / ⌘wheel=zoom / Wheel on note=velocity",
